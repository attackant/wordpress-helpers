...
$mapi_options->HelpTab(
	array(
		...
		'content' => '<p>API documentation is available online at <a href="https://github.com/attackant/topics/mindshare-theme-api/" target="_blank">https://github.com/attackant/topics/mindshare-theme-api/</a></p>'
	)
);
$mapi_options->HelpTab(
	array(
		'id'      => 'mapi-support-tab',
		'title'   => 'API Support',
		'content' => '<p>Get support on the Mindshare Labs forums: <a href="https://github.com/attackant/forums/" target="_blank">https://github.com/attackant/forums/</a></p><p>To get premium one-on-one support, contact us: <a href="http://mind.sh/are/contact/">http://mind.sh/are/contact/</a></p>'
	)
);
$mapi_options->HelpTab(
	array(
		...
		'content' => '<p>Download compatible free and premium themes from the Mindshare Labs: <a href="https://github.com/attackant/" target="_blank">https://github.com/attackant/</a></p>'
	)
);
