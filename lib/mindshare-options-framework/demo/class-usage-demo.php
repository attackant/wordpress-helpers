...
$config = array(
	...
	// text to use on the menu link
	'capability'       => 'edit_theme_options',
	// The capability needed to view the page
	'option_group'     => 'demo_options',
	//the name of the option to create in the database
	'id'               => 'mindshare-api-settings-temp',
	// meta box id, unique per page
	'fields'           => array(),
	// list of fields (can be added by field arrays)
	'project_path'     => 'PLUGIN',
	// 'THEME', 'PLUGIN', or custom path string, default is 'PLUGIN'
	'project_name'     => 'My Plugin or Theme Name',
	// Used for customizing text for the uninstall confirmation. Defaults to 'this'
	'google_fonts'     => true,
	'reset_button'     => false,
...
$options_panel->addSelect( 'select_field_id', array(
	'selectkey1' => 'Select Value1',
	'selectkey2' => 'Select Value2'
), array( 'name' => 'My select ', 'std' => array( 'selectkey2' ) ) );
$options_panel->addRadio( 'radio_field_id', array(
	'radiokey1' => 'Radio Value1',
	'radiokey2' => 'Radio Value2'
), array( 'name' => 'My Radio Filed', 'std' => array( 'radiokey2' ) ) );
$options_panel->CloseTab();

$options_panel->OpenTab( 'options_2' );
$options_panel->Title( "Fancy Options" );
$options_panel->addTypo( 'typography_field_id', array(
	'name' => "My Typography",
	'std'  => array(
		'size'  => '14px',
		'color' => '#000000',
...
$options_panel->addImage( 'image_field_id', array(
	'name'           => 'My Image ',
...
$options_panel->addTaxonomy( 'taxonomy2_field_id', array(
	'taxonomy' => 'category',
	'type'     => 'checkbox_list'
), array( 'name' => 'My Taxonomy Checkboxes' ) );
$options_panel->addPosts( 'posts2_field_id', array(
	'post_type' => 'post',
	'type'      => 'checkbox_list'
), array( 'name' => 'My Posts Checkboxes' ) );
...
$options_panel->addSortable( 'sortable_field_id', array(
	'1' => 'One',
	'2' => 'Two',
	'3' => 'three',
	'4' => 'four'
), array( 'name' => "my sortable field" ) );
 ...
 */
$options_panel->addRepeaterBlock( 're_', array(
	'sortable' => true,
	'inline'   => true,
