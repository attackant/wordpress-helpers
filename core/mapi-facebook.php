            ...
            <li class="mapi-fb-post">
				...
				<?php elseif ( $photo_url ) : ?>
                    <div class="mapi-fb-image">
						<?php if ( $post_result['link'] ) : ?><a href="<?php echo $post_result['link']; ?>"
                                                                 title="Posted <?php echo $post_date; ?>"><?php endif; ?>
                            <img src="<?php echo $photo_url; ?>" alt="<?php bloginfo( 'name' ); ?>"
                                 style="max-width: <?php echo get_option( 'medium_size_w' ); ?>px"/>
				...
				if ( $post_message ) : ?>
                    <div class="mapi-fb-message">
                        ...
                        <small class="mapi-fb-meta">
                            <br>Posted to <a href="<?php mapi_option( 'facebook_uri' ); ?>"
                                             title="Connect with <?php bloginfo( 'name' ); ?> ' on Facebook"
                                             target="_blank">Facebook</a> on <?php echo $post_date ?>
                        </small>
                    </div>
				<?php endif; ?>
	...
	if ( is_singular() ) : ?>
		...
		<?php else : ?>
            <meta property="og:image"
                  content="<?php echo esc_attr( mapi_get_attachment_image_src( null, 'medium' ) ); ?>"/>
		<?php endif; ?>
	<?php endif;
}
